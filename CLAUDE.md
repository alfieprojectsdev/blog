...
**TypeScript**: Uses strict TypeScript configuration (`astro/tsconfigs/strict`) with `strictNullChecks` enabled. Content collection types are auto-generated by Astro.
